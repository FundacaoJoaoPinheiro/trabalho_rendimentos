...
#	"V5007A", "V5008A", "VD4019", "VD4048", "VD4052")

# 7427, 7526, 7529 e 7564
...
desenho_amostral <- pnadc_design(subset(desenho_amostral,
	UF == "Minas Gerais", V2009 >= 14))
...
svytotal(~is.na(VD4019) + is.na(VD4020), desenho_amostral)
sidra_7426[c(7,3)]
